          ...
          <div className="h-full flex flex-col items-center justify-center max-w-[390px] mx-auto pt-9 text-primary dark:text-primary-dark">
            <div className="flex-1 w-full sm:text-base text-sm">
              ...
              <ul className="list-disc pl-5 block sm:text-base text-sm">
                <li className="mt-6 mb-2">
                  ...
                  Built on <a href="https://www.devangthakkar.com/">Devang Thakkar's</a> <a href="https://github.com/DevangThakkar/wordle_archive">Wordle Archive</a>,
                  which was built on <a href="https://twitter.com/katherinecodes">Katherine Peterson</a>'s <a href="https://octokatherine.github.io/word-master">WordMaster</a>.
                </li>
              </ul>
              <ul className="list-disc pl-5 block sm:text-base text-sm">
                <li className="mt-6 mb-2">Made with love by <a href="https:///github.com/joeyparrish">Joey Parrish</a>.</li>
              </ul>
            ...
            <div className="flex justify-center sm:text-base text-sm">
              ...
              <a
                ...
                href="https://github.com/joeyparrish/wordls-with-friends"
                target="_blank"
                rel="noreferrer"
              >
                <Github />
